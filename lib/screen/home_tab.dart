              ...
              child: filteredSchedules.isEmpty
                  ? Center(
                      child: Text(
                        '오늘은 일정이 없습니다.',
                        style:
                            TextStyle(color: DARK_GREY_COLOR, fontSize: 16.0),
                      ),
                    )
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            subtitle: Text(
                              '마감 기한: ${_formatDate(schedule['deadline'])}',
                              style: TextStyle(
                                color: DARK_GREY_COLOR,
                              ),
                            ),
                            leading: Checkbox(
                              ...
                              onChanged: (value) {
                                scheduleProvider.toggleComplete(scheduleProvider
                                    .schedules
                                    .indexOf(schedule));
                              },
  ...
  void _editSchedule(BuildContext context, ScheduleProvider provider,
    ...
    final result = await showModalBottomSheet<Map<String, dynamic>>(
      ...
      builder: (_) => ScheduleBottomSheet(
        selectedDate: schedule['deadline'],
